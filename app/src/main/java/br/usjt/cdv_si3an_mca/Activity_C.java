...
public class Activity_C extends AppCompatActivity {
    ...
    public void startDialog(View v) {
        Intent intent = new Intent(Activity_C.this, DialogActivity.class);
        startActivity(intent);
    }

    public void startActivityA(View v) {
        Intent intent = new Intent(Activity_C.this, br.usjt.cdv_si3an_mca.Activity_A.class);
        startActivity(intent);
    }

    public void startActivityB(View v) {
        Intent intent = new Intent(Activity_C.this, br.usjt.cdv_si3an_mca.Activity_B.class);
        startActivity(intent);
    }
